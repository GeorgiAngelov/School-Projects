...
int main(int argc, char * argv[])
{
	...
	testList.push_back(
	std::make_pair(std::pair<unsigned short,unsigned short>(400,360),
	std::pair<unsigned short,unsigned short>(360,240)) );
	testList.push_back(
	std::make_pair(std::pair<unsigned short,unsigned short>(800,720),
	std::pair<unsigned short,unsigned short>(720,800)) );
	testList.push_back(
	std::make_pair(std::pair<unsigned short,unsigned short>(1600,1000),
	std::pair<unsigned short,unsigned short>(1000,1600)) );
	testList.push_back(
	std::make_pair(std::pair<unsigned short,unsigned short>(1600,2000),
	std::pair<unsigned short,unsigned short>(2000,1600)) );
	testList.push_back(
	std::make_pair(std::pair<unsigned short,unsigned short>(3200,2000),
	std::pair<unsigned short,unsigned short>(2000,3200)) );
	testList.push_back(
	std::make_pair(std::pair<unsigned short,unsigned short>(3200,4000),
	std::pair<unsigned short,unsigned short>(4000,3200)) );
